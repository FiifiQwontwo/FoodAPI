...
from .views import RestaurantList, RestaurantCreateView, MenuList, MenuCreateView, OrderListView, CreateOrderView,DeliveryListView, CreateDeliveryView, RestaurantDetailAPI
